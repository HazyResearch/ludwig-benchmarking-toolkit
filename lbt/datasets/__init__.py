...
PRE_BUILT_DATASETS = {
    ...
    "MercedesBenzGreener": "ludwig.datasets.mercedes_benz_greener",
    "SantanderValuePrediction": "ludwig.datasets.santander_value_prediction",
    "BNPClaimsManagement": "ludwig.datasets.bnp_claims_management",
    "SantanderCustomerTransaction": "ludwig.datasets.santander_customer_transaction",
    "IEEEFraud": "ludwig.datasets.ieee_fraud",
    "WalmartRecruiting": "ludwig.datasets.walmart_recruiting",
    "OttoGroupProduct": "ludwig.datasets.otto_group_product",
    "PokerHand": "ludwig.datasets.poker_hand",
    "Sarcos": "ludwig.datasets.sarcos",
    "AdultCensusIncome": "ludwig.datasets.adult_census_income",
    "RossmannStoreSales": "ludwig.datasets.rossmann_store_sales",
    "AllstateClaimsSeverity": "ludwig.datasets.allstate_claims_severity",
    "PortoSeguroSafeDriver": "ludwig.datasets.porto_seguro_safe_driver",
    "SantanderCustomerSatisfaction": "ludwig.datasets.santander_customer_satisfaction",
}
